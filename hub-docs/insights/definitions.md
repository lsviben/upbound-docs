...
**Resource Exploration**. The tab strip on the Resources page, the quick access
list on the home page, and the command palette all reach the same view, which
lives at `/explore/definitions`.
